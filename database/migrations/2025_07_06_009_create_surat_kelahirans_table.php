...
return new class extends Migration
{
    ...
    {
        Schema::create(DbConst::SURAT_KELAHIRAN, function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('bayi_id')->references('id')->on(DbConst::BAYI);
    ...
    {
        Schema::dropIfExists(DbConst::SURAT_KELAHIRAN);
    }
};
